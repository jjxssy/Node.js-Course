...
const dbSingleton = require('./dbSingletons/dbSingletonUsers'); // Import the singleton connection module
const db = dbSingleton.getConnection(); // Get the singleton connection
